...
ALTER TABLE cargos COMMENT 'essa e uma tabela de cargos';
...
ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'mínimo de salário no cargo';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'máximo de salário no cargo';

--criando chave unica
CREATE UNIQUE INDEX cargos_idx
 ON cargos
 ( cargo );
--creando tabela regioes
...
ALTER TABLE regioes COMMENT 'essa e uma tabela de regioes';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Primária';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'nome região';

--creando chave primaria
CREATE UNIQUE INDEX regioes_idx
 ON regioes
 ( nome );
--creando tabela paises
CREATE TABLE paises (
...
ALTER TABLE paises COMMENT 'essa e uma tabela de paises';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'chave primária';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'nome país';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'chave estrangeira tabela regiões';

--creando chave unica
CREATE UNIQUE INDEX paises_idx
 ON paises
 ( nome );
--creando tabela localizacoes
...
ALTER TABLE localizacoes COMMENT 'essa e uma tabela de localizacoes';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'chave primária';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'endereço escritório';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'cep escritório';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'cidade escritório';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'estado localizado';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'páis  escritório';
...
ALTER TABLE departamentos COMMENT 'essa e uma tabela de departamentos';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'chave primária';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'nome departamento';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'chave estrangeira tabela localizações';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'chave estrangeira';

--creando chave unica
CREATE UNIQUE INDEX departamentos_idx
 ON departamentos
 ( nome );
--creando tabela empregados
...
ALTER TABLE empregados COMMENT 'essa e uma tabela de empregados';

ALTER TABLE empregados MODIFY COLUMN id_empregado INTEGER COMMENT 'chave primária';

ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'nome funcionários do departamento';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'e-mail funcionário';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'telefone do funcionário';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'data de contratação do funcionário';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'chave estrangeira tabela cargos';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'salário funcionário no departamento';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'comissão para empregados que estão no departamento de vendas';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'chave estrangeira tabela departamentos';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'chave estrangeira auto relacionamento';

--creando chave unica
CREATE UNIQUE INDEX empregados_idx
 ON empregados
 ( email );
--creando tabela historico_cargos
...
ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'data de saída do funcionário';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'chave estrangeira que vem da tabela departamentos';
